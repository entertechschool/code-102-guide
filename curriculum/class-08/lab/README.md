...
1. Agrega validación en uno de los inputs del usuario.
    - Siga preguntando hasta que se ingrese un valor aceptable.
...
¡Comparte un enlace a tu página implementada para que lo disfruten tus compañeros de clase! Echa un vistazo a la página de otra persona y pruébala.
